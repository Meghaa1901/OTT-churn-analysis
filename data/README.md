# Data for OTT Subscription Churn Analysis

This folder contains the RavenStack Synthetic SaaS Dataset used in my OTT Subscription Churn Analysis project.
The dataset was created by River @ Rivalytics and is used here for educational/portfolio purposes.
